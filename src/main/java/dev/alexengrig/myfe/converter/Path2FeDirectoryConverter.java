...
/**
 * Converter from {@link Path} to {@link FeDirectory}.
 */
public class Path2FeDirectoryConverter implements Converter<Path, FeDirectory> {

    @Override
    public FeDirectory convert(Path source) {
